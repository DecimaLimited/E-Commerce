...
<div class="wrapper">
                                    ...
                                    <select class="form-control" id="membershipType" name="membershipType" required>
                                        ...
                                        <label for="extendate">Renew Upto</label>
                                            <select class="form-control" id="extend" name="extend" required>
                                                ...
                                                <option value="6">Nine Months</option>
    ...
    <strong> &copy; <?php echo date('Y');?> decimalimted.com</a> -</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Developed By</b> <a href="https://decimalimited.com/">DECIMA LIMITED</a>
    </div>
    </footer>
</div>
<!-- ./wrapper -->
